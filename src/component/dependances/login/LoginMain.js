...
const Loginmain = () => {
    ...
    useEffect(() => {
        ...
        const savedData = JSON.parse(window.localStorage.getItem('userData'))// get local storage
    ...
    const userLogin = async (e) => {
        ...
        if (newData.data) {
            ...
            if (checkRef.current.checked) window.localStorage.setItem('userData', JSON.stringify(ids))  //store in localstorage
            navigate('/dashboard')
        }
    }
    return (
